...
services = [
    ...
    ('Оснащение центра', '/services/equipment.html', 'Испытательные комплексы, измерительное и генераторное оборудование'),
]
...
<header class="site-header">
  <div class="container nav">
    <a class="brand" href="{depth}index.html">
      ...
      <span class="brand-text"><strong>Дизайн-центр «Бином»</strong><span>Проектирование, автоматизация, ПО и испытания</span></span>
    </a>
    ...
    <nav class="nav-links" data-nav-links>
      ...
      <a class="nav-link" href="{depth}about.html">О центре</a>
...
<footer class="site-footer">
  <div class="container footer-inner">
    <div>© <span data-year></span> Дизайн-центр микроэлектроники «Бином»</div>
    <div class="footer-links">
      <a href="{depth}index.html">Главная</a>
      <a href="{depth}about.html">О центре</a>
...
<section class="hero">
  <div class="container hero-content">
    <div>
      <div class="eyebrow">Проектирование, автоматизация и микроэлектроника</div>
      <h1>Разрабатываем инженерные решения, программные продукты и испытательные комплексы для промышленности и науки</h1>
      <p>Дизайн-центр «Бином» помогает заказчикам пройти путь от идеи и технического задания до опытного образца, программного продукта, автоматизированной установки и комплекта документации для внедрения.</p>
...
<section class="section">
  <div class="container">
    ...
    <h2 class="section-title">Услуги дизайн-центра</h2>
...
about_body = hero_page('О дизайн-центре', 'Мы выполняем исследования и разработки в области радиоэлектронной аппаратуры, микроэлектроники, программного обеспечения, автоматизации и испытательных технологий для систем различного назначения.') + '''
<section class="section">
  <div class="container split">
    <div class="reveal">
...
team_body = hero_page('Команда дизайн-центра', 'На странице собрана базовая презентация ключевых специалистов. Карточки легко редактируются, поэтому позже сюда можно добавить реальные фото, должности, публикации и направления экспертизы.') + '''
<section class="section">
...
<section class="section">
  <div class="container contact-box reveal">
    ...
    <p class="lead" style="max-width:none;">Настоящая политика описывает порядок обработки персональных данных пользователей сайта дизайн-центра «Бином». Оператор принимает необходимые организационные и технические меры для защиты информации от неправомерного доступа, изменения, раскрытия или уничтожения.</p>
...
<section class="section"><div class="container split"><div class="reveal"><h2 class="section-title">Форматы работы</h2><ul class="check-list"><li>короткие прикладные консультации по постановке задачи;</li><li>программы повышения квалификации;</li><li>корпоративные курсы под нужды предприятия;</li><li>сопровождение студенческих и инженерных команд.</li></ul></div><div class="contact-box reveal"><p>По завершении курса можно предусмотреть выдачу документов установленного образца, а сам сайт можно дополнить отдельной страницей с перечнем программ, темами занятий и форматом записи.</p></div></div></section>'''
    ...
    'services/equipment.html': (
        'Оснащение дизайн-центра',
        'Испытательная база, генераторы, анализаторы и измерительные комплексы.',
        hero_page('Оснащение дизайн-центра', 'Центр располагает испытательной и измерительной базой, которая позволяет проводить анализ, отладку, проверку работоспособности и демонстрацию инженерных решений заказчикам и партнерам.') + '''
...
pages = {
    'index.html': ('Дизайн-центр «Бином»', 'Сайт дизайн-центра «Бином»: услуги, проекты, контакты и инженерные компетенции.', index_body),
    'about.html': ('О дизайн-центре', 'О центре, направления работ и формат взаимодействия с заказчиками.', about_body),
    'team.html': ('Команда дизайн-центра', 'Ключевые специалисты и структура команды.', team_body),
...
(root / 'README.md').write_text('''# Сайт дизайн-центра «Бином»
